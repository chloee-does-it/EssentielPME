...
<div class="consent-overlay" data-consent-banner hidden>
...
${field('Téléphone', 'phone', 'tel', 'tel')}
              ...
              <div style="display:flex; flex-direction:column; gap:8px;">
                ...
                <div class="interest-group" role="radiogroup" aria-label="Ce qui vous intéresse">
                  <input type="radio" name="interest" id="int-essentiel" value="Publicité : Essentiel (695 $/mois)"><label for="int-essentiel">Essentiel</label>
                  <input type="radio" name="interest" id="int-plus" value="Publicité : Essentiel Plus (995 $/mois)"><label for="int-plus">Essentiel Plus</label>
                  <input type="radio" name="interest" id="int-performance" value="Publicité : Essentiel Performance (1 495 $/mois)"><label for="int-performance">Essentiel Performance</label>
